...
export default function SubscriptionForm({ onSubmit, initialData, currencyList }) {
  ...
  return (
    <form
      ...
      className="bg-white shadow-md rounded-lg p-6 mb-6 max-w-3xl"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium mb-1">Max Users <span className="text-red-500">*</span></label>
          <input
            type="number"
            name="maxUserCount"
