...
//         maxUserCount: Number(initialData.maxUserCount) || "",
//         price: Number(initialData.price) || "",
//         currencyId: Number(initialData.currencyId) || "",
//       });
//     }
//   }, [initialData]);
...
//   return (
//     <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg p-6 mb-6 max-w-2xl">
...
export default function SubscriptionForm({ onSubmit, initialData, currencyList }) {
  ...
  useEffect(() => {
    if (initialData) {
      setForm({
        ...
        price: Number(initialData.price) || "",
        currencyId: Number(initialData.currencyId) || "",
        storageLimit: Number(initialData.storageLimit) || 0, // use initialData if present
      });
    }
  }, [initialData]);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onSubmit(form); // includes storageLimit from state
